...
5. **Phase 2: Implementation & Verification**:
   - Write clean, robust code with clear error handling.
   - Write and run comprehensive automated test suites covering positive, boundary, and negative failure cases.
   - Stay strictly within workspace boundaries.

6. **Gate 2: Senior Staff Dev & QA Reviewer Subagent**:
   - Spawn/invoke the reviewer subagent acting as a **rigorous senior staff engineer & QA reviewer**.
   ...
   - **Quality & Correctness (60%):** Verify functionality, automated tests, edge cases, zero-leak sanitization, idempotency, and cross-platform portability.
